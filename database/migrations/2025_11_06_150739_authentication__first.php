...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Schema::create('user_passwds', function (Blueprint $table) {
        //     $table->id();
    ...
    {
        // Schema::dropIfExists('user_passwd_reset_tokens');
        // Schema::dropIfExists('user_sessions');
        // Schema::dropIfExists('user_second_identities');
        // Schema::dropIfExists('user_passwds');
