// resources/js/Components/Badge/AdminBadge.tsx

import * as React from 'react';

// Terima props standar SVG seperti className, width, height, dll.
interface AdminBadgeProps extends React.SVGProps<SVGSVGElement> {}

const AdminBadge = (props: AdminBadgeProps) => (
    <svg
        // Default width and height, bisa di-override via props
        width="24" // Ukuran default yang wajar untuk badge
        height="24"
        id="Layer_1"
        ...
        viewBox="0 0 512 512"
        xmlSpace="preserve"
        {...props} // Sebarkan sisa props (className, style, dll.)
    >
        <circle
            style={{
                fill: '#FFC61B', // Kuning
